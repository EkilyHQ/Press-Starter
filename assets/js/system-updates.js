...
import { t } from './i18n.js?v=repository-deletion-docs-20260508';
...
const SYSTEM_UPDATE_ALLOWED_PATH_PATTERN = /^(?:index\.html|index_editor\.html|assets\/(?:main\.js|js\/.+|i18n\/.+|schema\/.+|themes\/native\/.+))$/;
