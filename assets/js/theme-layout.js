import { getSavedThemePack, loadThemePack } from './theme.js?v=connect-publish-20260508';
import {
  t,
  withLangParam,
  getCurrentLang,
  ...
  getAvailableLangs,
  getLanguageLabel
} from './i18n.js?v=connect-publish-20260508';
import {
...
const NATIVE_MODULE_CACHE_KEY = 'connect-publish-20260508';
