...
const translations = {
    ...
    editor: {
      ...
      tree: {
        ...
        systemUpdatesMeta: '檢視並套用 Press 更新。',
      ...
      welcome: {
        ...
        faqUpdatesQuestion: 'Press 更新會改什麼？',
      ...
      composer: {
        ...
        github: {
          modal: {
            ...
            connectTitle: 'Ekily Connect 發布',
            connectHelp: ({ baseUrl }) => `已透過 ${baseUrl} 設定 GitHub App 發布。`,
            connectReady: '發布時登入 GitHub 即可，無需個人訪問令牌。',
            connectConnected: '目前瀏覽器工作階段已準備好 GitHub 登入。',
            publishMethodConnect: 'Connect',
            publishMethodPat: '個人令牌',
            connectBaseUrlLabel: 'Connect URL',
            connectBaseUrlHelp: '選擇內建 Connect 遠端，或輸入相容的部署 URL。此設定只會保存在此瀏覽器。',
        ...
        markdown: {
          ...
          protection: {
            ...
            labelProtected: '已保護',
            labelUnprotected: '保護',
            tooltipNoFile: '請先開啟一個 Markdown 檔案再更改保護設定。',
            tooltipProtected: '這篇文章已加密。可更改密碼或關閉保護。',
            tooltipUnprotected: '使用每篇文章獨立的密碼加密正文。',
            dialogTitle: '文章密碼',
            dialogMessage: '輸入文章密碼以繼續。',
            passwordLabel: '密碼',
            confirmPasswordLabel: '確認密碼',
            passwordRequired: '加密這篇文章需要密碼。',
            passwordRequiredOpen: '開啟受保護文章需要密碼。',
            passwordMismatch: '兩次輸入的密碼不一致。',
            openTitle: '解鎖受保護文章',
            openMessage: '載入到編輯器前請輸入文章密碼。',
            draftTitle: '解鎖受保護草稿',
            draftMessage: '請輸入文章密碼以恢復加密的本地草稿。',
            passwordTitle: '保持文章加密',
            passwordMessage: '請輸入文章密碼，以便將草稿加密儲存。',
            enableTitle: '保護文章',
            enableMessage: '設定一個密碼。Press 會在儲存或發佈前加密文章正文。',
            changeTitle: '更改文章密碼',
            changeMessage: '設定新密碼。當前明文只保留在這個已開啟頁面的記憶體中。',
            changePrompt: '這篇文章已受保護。要更改密碼嗎？',
            disableConfirm: '關閉保護並以明文發佈這篇文章？',
            enable: '啟用保護',
            unlock: '解鎖',
            keepEncrypted: '保持加密',
            changePassword: '更改密碼',
            keepProtection: '保持保護',
            disable: '關閉保護',
            enabledToast: '已啟用文章保護。',
            disabledToast: '已關閉文章保護。',
            passwordChangedToast: '已更改文章密碼。',
            unlockFailed: '無法使用該密碼解鎖。',
            invalidEnvelope: '受保護文章 envelope 無效。',
            prepareFailed: '準備加密 Markdown 失敗。'
          },
          draftIndicator: {
      ...
      footerNote: '由 ❤️ 打造，基於 <a href="https://ekilyhq.github.io/Press/" target="_blank" rel="noopener">Press</a>。保持靈感，持續創作。'
    },
  }
