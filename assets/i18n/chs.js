      ...
      composer: {
        ...
        github: {
          modal: {
            ...
            connectTitle: 'Ekily Connect 发布',
            connectHelp: ({ baseUrl }) => `已通过 ${baseUrl} 配置 GitHub App 发布。`,
            connectReady: '发布时登录 GitHub 即可，无需个人访问令牌。',
            connectConnected: '当前浏览器会话已准备好 GitHub 登录。',
            publishMethodConnect: 'Connect',
            publishMethodPat: '个人令牌',
            connectBaseUrlLabel: 'Connect URL',
            connectBaseUrlHelp: '选择内置 Connect 远端，或输入兼容的部署 URL。该设置仅保存在此浏览器中。',
        ...
        markdown: {
          ...
          protection: {
            ...
            labelProtected: '已保护',
            labelUnprotected: '保护',
            tooltipNoFile: '请先打开一个 Markdown 文件再更改保护设置。',
            tooltipProtected: '这篇文章已加密。可更改密码或关闭保护。',
            tooltipUnprotected: '使用每篇文章独立的密码加密正文。',
            dialogTitle: '文章密码',
            dialogMessage: '输入文章密码以继续。',
            passwordLabel: '密码',
            confirmPasswordLabel: '确认密码',
            passwordRequired: '加密这篇文章需要密码。',
            passwordRequiredOpen: '打开受保护文章需要密码。',
            passwordMismatch: '两次输入的密码不一致。',
            openTitle: '解锁受保护文章',
            openMessage: '加载到编辑器前请输入文章密码。',
            draftTitle: '解锁受保护草稿',
            draftMessage: '请输入文章密码以恢复加密的本地草稿。',
            passwordTitle: '保持文章加密',
            passwordMessage: '请输入文章密码，以便将草稿加密保存。',
            enableTitle: '保护文章',
            enableMessage: '设置一个密码。Press 会在保存或发布前加密文章正文。',
            changeTitle: '更改文章密码',
            changeMessage: '设置新密码。当前明文只保留在这个已打开页面的内存中。',
            changePrompt: '这篇文章已受保护。要更改密码吗？',
            disableConfirm: '关闭保护并以明文发布这篇文章？',
            enable: '启用保护',
            unlock: '解锁',
            keepEncrypted: '保持加密',
            changePassword: '更改密码',
            keepProtection: '保持保护',
            disable: '关闭保护',
            enabledToast: '已启用文章保护。',
            disabledToast: '已关闭文章保护。',
            passwordChangedToast: '已更改文章密码。',
            unlockFailed: '无法使用该密码解锁。',
            invalidEnvelope: '受保护文章 envelope 无效。',
            prepareFailed: '准备加密 Markdown 失败。'
          },
          draftIndicator: {
